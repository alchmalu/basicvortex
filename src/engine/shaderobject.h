...
public:
    ...
    void setTransform(glm::mat4x4 modelView, glm::mat4x4 projection, glm::mat4x4 mvp, glm::mat4x4 normal) {
        /**********     METHOD WITHOUT UBO    *******/
/*
              glAssert ( glUniformMatrix4fv ( glGetUniformLocation ( mId, "modelViewMatrix" ), 1, GL_FALSE, glm::value_ptr ( modelView ) ) );
              glAssert ( glUniformMatrix4fv ( glGetUniformLocation ( mId, "projectionMatrix" ), 1, GL_FALSE, glm::value_ptr ( projection ) ) );
              glAssert ( glUniformMatrix4fv ( glGetUniformLocation ( mId, "MVP" ), 1, GL_FALSE, glm::value_ptr ( mvp ) ) );
              glAssert ( glUniformMatrix4fv ( glGetUniformLocation ( mId, "normalMatrix" ), 1, GL_FALSE, glm::value_ptr ( normal ) ) );
*/

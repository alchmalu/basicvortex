...
//    Q_OBJECT
  ...
  public:
    ...
    page</a>). */
    glm::vec3 revolveAroundPoint() const { return revolveAroundPoint_; }
    /*! Sets the revolveAroundPoint(), defined in the world coordinate system. */
    void setRevolveAroundPoint(const glm::vec3& revolveAroundPoint) { revolveAroundPoint_ = revolveAroundPoint; }
    //@}
  ...
  //public Q_SLOTS:
    ...
    void setFlyUpVector(const glm::vec3& up) { flyUpVector_ = up; }
  ...
  public:
    ...
    instead. */
    glm::vec3 flyUpVector() const { return flyUpVector_; }
    //@}

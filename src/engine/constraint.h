...
namespace vortex {
  ...
  */
  ...
  public:
    ...
    virtual void constrainTranslation(glm::vec3& translation, Frame* const frame) { (void)translation; (void)frame; };
    ...
    virtual void constrainRotation(Quaternion& rotation, Frame* const frame) { (void)rotation; (void)frame; };
  };
  ...
  public:
    ...
    glm::vec3 translationConstraintDirection() const { return translationConstraintDir_; };
    //@}
